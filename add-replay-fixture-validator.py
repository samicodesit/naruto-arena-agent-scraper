...
write("scripts/validate-replay-fixtures.mjs", r"""
    #!/usr/bin/env node
...
package_json["scripts"]["clone:validate-fixtures"] = "node scripts/validate-replay-fixtures.mjs"
package_path.write_text(json.dumps(package_json, indent=2) + "\n", encoding="utf-8")

subprocess.run(["node", "--check", "scripts/validate-replay-fixtures.mjs"], check=True)

print("Added scripts/validate-replay-fixtures.mjs")
print("Added npm script: clone:validate-fixtures")
print("")
print("Next commands:")
print("  npm run -s clone:validate-fixtures")
print("  node scripts/ai-handoff.mjs \"add replay fixture validator\" --validate-active")
